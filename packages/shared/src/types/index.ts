...
export type TabType = "tasks" | "notes" | "spreadsheet" | "markdown" | "data_table" | "postgres" | "api" | "workflow" | "time_tracking";
...
> = {
  ...
  pro: {
    ...
    maxConcurrentJobs: 5,
    maxPagesPerAgent: 20,
    allowedPageTypes: ["tasks", "notes", "spreadsheet", "markdown", "data_table", "postgres", "api", "workflow", "time_tracking"],
